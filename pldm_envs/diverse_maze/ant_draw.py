...
def load_environment(
    ...
    # NOTE: Initialize viewer and update target marker (FIXED for put the red point inside the maze)
    if map_key is not None:
        env.render(mode="rgb_array")  # Initialize viewer
        env.set_marker()  # Update target position
