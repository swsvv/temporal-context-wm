...
from pldm.objectives.contextemb import ContextEMBObjective, ContextEMBObjectiveConfig
...
class ObjectivesConfig:
    ...
    contextemb: ContextEMBObjectiveConfig = ContextEMBObjectiveConfig()  
    ...
    def build_objectives_list(
        ...
        for objective_type in self.objectives:
            ...
            elif objective_type == ObjectiveType.ContextEMB:
                objectives.append(
                    ContextEMBObjective(
                        self.contextemb, name_prefix=name_prefix, repr_dim=repr_dim
                    )
                )
            else:
